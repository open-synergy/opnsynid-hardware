function proxy_backend_serial_relay_action(instance, module){
    ...
    instance.proxy_backend_serial_relay.serial_relay_on = function (instance, context) {
        ...
        this.device.get_device()
            ...
            .then(function(backend){
                if (backend != null){
                    parent.proxy.message_json(backend, "POST", "serial_relay_on", {"port": parent.device_name, "pin": parent.pin, "delay": parent.delay})
                        .done(function(){
    ...
    instance.proxy_backend_serial_relay.serial_relay_off = function (instance, context) {
        ...
        this.device.get_device()
            ...
            .then(function(backend){
                if (backend != null){
                    parent.proxy.message_json(backend, "POST", "serial_relay_off", {"port": parent.device_name, "pin": parent.pin, "delay": parent.delay})
                        .done(function(){
                            // alert("Connected to proxy device");
                        })
                        .fail(function(){
